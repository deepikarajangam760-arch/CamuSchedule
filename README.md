...
<div class="wrapper">
    ...
    <div class="navigation">
        ...
        <ul class="nav-links">
            ...
            <li>Assessments</li>
            <li class="selected">Timetable</li>
            <li>Holidays</li>
            <li>Events</li>
            <li>Billing</li>
    ...
    <div class="dashboard">
        ...
        <div class="schedule-section">
            <div class="page-heading">Timetable</div>
            <div class="semester-row">
                <h4>EVEN-JUNIOR I 2025-2026</h4>
            ...
            <div class="class-list">
                ...
                <div class="class-item">
                    ...
                    <p>1:00 PM - 2:00 PM (60 min) | PRADEEP</p>
                </div>
                <div class="class-item">
                    <h4>Mentor Meet (ECA-M)</h4>
                    <p>2:00 PM - 3:00 PM (60 min) | PRADEEP</p>
                </div>
...
![alt text](<Screenshot 2026-05-28 203628.png>)
